...
{% include figure.liquid loading="eager" path="assets/img/trustworthy/judge_confusion_matrices.png" class="img-fluid rounded z-depth-1" zoomable=true caption="Confusion matrices for five judge models on the same 145-case bench (62 legitimate, 83 fakes). Rows are the intended verdict, columns the judge's majority verdict over three samples. FP is a legitimate case flagged; FN is a fake approved." %}
